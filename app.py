...
model = pickle.load(open("C:\\Users\\Acer\\OneDrive\\Desktop\\flight_prediction.pkl", 'rb'))
...
def main():
    ...
    with st.container():
        ...
        destination_mapping = {destination: 1 if destination == selected_destination else 0 for destination in
                               destinations}
